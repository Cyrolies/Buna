...
namespace CyroTechPortal
{
    public class JQueryDataTablesModelBinder : IModelBinder
    {
        ...
        private const string sColumnsKey = "sColumns";
        ...
        public object BindModel(ControllerContext controllerContext, ModelBindingContext bindingContext)
        {
            ...
            dataTablesRequest.sColumns_ = GetStringList(sColumnsKey);
            ...
            dataTablesRequest.sSearch_ = new Collection<string> (GetStringList(sSearch_Key));
