...
namespace  DALEFModel
{
	...
	[MetadataTypeAttribute(typeof(ExportDataControl.ExportDataControlMetadata))]
	public partial class ExportDataControl
    {
		internal sealed class ExportDataControlMetadata
		{
			// Metadata classes are not meant to be instantiated.
			private ExportDataControlMetadata()
			{
			}
