...
$sqlmaparray = "SELECT * 
			  ...
			  WHERE (      typeofFish = 'Shrimp'
            OR typeofFish4 = 'Shrimp'
        OR typeofFish5 = 'Shrimp')";
					...
					$icon = "https://buna.africa/images/icons/shrimp.png";
...
//Create an array with the two datasets
	...
	var locations = [
        ...
        [
            'Farmers',
            '<p><b><?php echo $locations[$i]['name'];?></b><br>No. of ponds: <?php echo $locations[$i]['ponds'];?><br>Latitude: <?php echo $locations[$i]['lat'];?><br>Longitude: <?php echo $locations[$i]['lng'];?></p>',
