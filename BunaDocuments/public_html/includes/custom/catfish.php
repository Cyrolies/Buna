...
$sqlmaparray = "SELECT *
 ...
 WHERE (      typeofFish = 'Catfish'
            OR typeofFish4 = 'Catfish'
        OR typeofFish5 = 'Catfish')";
...
//Create an array with the two datasets
	...
	var locations = [
        ...
        [
            'Farmers',
            '<p><b><?php echo $locations[$i]['name'];?></b><br>No. of ponds: <?php echo $locations[$i]['ponds'];?><br><br>Latitude: <?php echo $locations[$i]['lat'];?><br>Longitude: <?php echo $locations[$i]['lng'];?></p>',
