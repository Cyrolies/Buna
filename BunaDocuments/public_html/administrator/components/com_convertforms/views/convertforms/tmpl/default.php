...
echo \NRFramework\HTML::checkForOutdatedExtension('com_convertforms');
	...
	<span class="span4 col-md-4">
		<?php if (!$downloadKey) { ?>
			<div class="alert alert-info mt-0">
				...
				<p class="mb-0"><a class="btn btn-small btn-sm btn-primary" href="<?php echo JURI::base() ?>index.php?option=com_plugins&view=plugins&filter_search=novarain">
